...
RUN pip install numpy==1.23.0 scikit-learn==1.3.2 scipy==1.10.1 xgboost==2.0.3 statsmodels==0.13.5 lifelines==0.27.8 rasterio==1.3.5.post1 ujson==5.8.0
...
RUN pip install segmentation-models-pytorch==0.3.4
RUN pip install tf-models-official==2.17.0
